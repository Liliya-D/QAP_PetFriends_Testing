...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = ""):
        ...
        либо 'my pets' - получить список собственных питомцев"""
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет на сервер данные о добавляемом питомце и возвращает статус запроса на сервер и
        ...
        data = MultipartEncoder(
                ...
                'age': age,
                'pet_photo': (pet_photo.split("/")[-1], open(pet_photo, 'rb'), 'image/jpeg')
            }
        )
        headers = {
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        ...
        результат в формате JSON с текстом уведомления об успешном удалении"""
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Метод отправляет запрос на сервер об обноволении данных питомца по указанному ID и возвращает
        статус запроса и result в формате JSON с обновлёнными данными питомца"""
    ...
    def add_new_pets(self, api_key, name, animal_type, age, pet_photo):
        pass